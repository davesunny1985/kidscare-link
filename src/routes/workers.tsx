  ...
  return (
    <>
      ...
      <section className="container-page py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold">Care work, reimagined</h2>
      ...
      <section className="bg-gradient-soft py-20">
        <div className="container-page">
          <h2 className="text-3xl md:text-4xl font-bold text-center">Everything you need to thrive</h2>
